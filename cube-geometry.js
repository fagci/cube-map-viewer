...
class CubeGeometry extends THREE.BoxGeometry {
  constructor(size) {
    ...
    var face1 = [new THREE.Vector2(0,   1), new THREE.Vector2(0,   0), new THREE.Vector2(1/6, 0), new THREE.Vector2(1/6, 1)];
    var face2 = [new THREE.Vector2(1/6, 1), new THREE.Vector2(1/6, 0), new THREE.Vector2(2/6, 0), new THREE.Vector2(2/6, 1)];
    var face3 = [new THREE.Vector2(2/6, 1), new THREE.Vector2(2/6, 0), new THREE.Vector2(3/6, 0), new THREE.Vector2(3/6, 1)];
    var face4 = [new THREE.Vector2(3/6, 1), new THREE.Vector2(3/6, 0), new THREE.Vector2(4/6, 0), new THREE.Vector2(4/6, 1)];
    var face5 = [new THREE.Vector2(4/6, 1), new THREE.Vector2(4/6, 0), new THREE.Vector2(5/6, 0), new THREE.Vector2(5/6, 1)];
    var face6 = [new THREE.Vector2(5/6, 1), new THREE.Vector2(5/6, 0), new THREE.Vector2(6/6, 0), new THREE.Vector2(6/6, 1)];
